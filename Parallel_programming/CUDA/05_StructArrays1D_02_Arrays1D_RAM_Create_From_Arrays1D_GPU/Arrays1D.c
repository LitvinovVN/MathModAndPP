...
/* Создаёт структуру типа Arrays1D в RAM как копию структуры Arrays1D,
 расположенной в GPU, и возвращает на неё указатель */
 Arrays1D* Arrays1D_RAM_Create_From_Arrays1D_GPU(Arrays1D* arrays1D_GPU)
 {
    Arrays1D* arrays1D_RAM = (Arrays1D*)malloc(sizeof(Arrays1D));
